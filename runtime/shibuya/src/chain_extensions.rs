...
pub use pallet_chain_extension_nomination_pools_staking::NominationPoolsStakingExtension;
...
impl RegisteredChainExtension<Runtime> for NominationPoolsStakingExtension<Runtime> {
    const ID: u16 = 03;
}
